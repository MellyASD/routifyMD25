...
export class Migrations1763085676790 implements MigrationInterface {
    name = 'Migrations1763085676790'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`transports\` (\`id\` varchar(36) NOT NULL, \`type\` enum ('bus', 'taxi', 'metro', 'bicycle', 'walking', 'private_car') NOT NULL, \`origin\` varchar(255) NOT NULL, \`destination\` varchar(255) NOT NULL, \`distance\` decimal(10,2) NOT NULL, \`duration\` int NOT NULL, \`cost\` decimal(10,2) NOT NULL, \`comfort\` decimal(5,2) NOT NULL, \`reliability\` decimal(5,2) NOT NULL, \`notes\` varchar(255) NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`comparisonId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
