...
const ADMIN_HASH = '$2b$10$zuNpl27sMOOTu6lFIaMtjugw3QmLLUSP80Yh0iLJ7Emb.hGJxSW6i'; // hash 'admin123'
const ADMIN_NAME = 'Administrador';

export class SeedAdmin1763510761748 implements MigrationInterface {
